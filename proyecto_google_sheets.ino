...
String eventName = "distancia";
String IFTTT_Key = "c_ogSXoQN2-9M98IXQvh9e";
...
void sendDataToSheet() {
  String url = "https://maker.ifttt.com/trigger/" + eventName + "/with/key/" + IFTTT_Key + "?value1=" + String(distancia) ;
  Serial.println(url);
